...
def main():
    ...
    if len(sys.argv) == 3:
        ...
        print("运行方式如: python3 xxx.py 9999 mini_frame:application")
        return
    ...
    # 获取另外一个模块可以直接调用的函数(对象),app就是mini_frame框架的application函数
