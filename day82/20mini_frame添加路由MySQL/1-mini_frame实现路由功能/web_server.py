...
def main():
    ...
    # 从配置文件中获取端口和框架应用名称
    port = conf_info.get('port', None)  # 如果配置文件中有port则使用，否则使用命令行参数
    frame_app_name = conf_info.get('framework', None)  # 同上
    ...
    if ret:
        ...
        print("框架应用名称格式错误:")
        print("应为 mini_frame:application 格式")
        return
    ...
    # import frame_name --->找frame_name.py，frame_name 是mini_frame
